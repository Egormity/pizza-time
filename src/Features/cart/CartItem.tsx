...
export default function CartItem({ item }: { item: CartItem }) {
  ...
  return (
    ...
    <div className='grid max-w-[45rem] grid-cols-2 overflow-hidden rounded-xl border border-zinc-700 bg-zinc-800 bg-opacity-5 duration-primary hover:scale-[1.025] max500px:grid-cols-1'>
