  ...
  return createPortal(
    <div className='fixed-centered flex-centered padding-page-x z-50 h-screen w-screen backdrop-blur-sm backdrop-brightness-90'>
      <div
        ...
        ref={ref}
        className={`${screenHeight < 500 ? 'px-4 pb-6 pt-14' : 'px-12 pb-10 pt-20'} relative border border-zinc-300 bg-zinc-900 shadow-2xl shadow-zinc-800 max500px:w-full min500px:w-[30rem]`}
      >
